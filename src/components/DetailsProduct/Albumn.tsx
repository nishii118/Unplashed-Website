...
import { Albumn } from "../../store/userSlice";
// import { useAppSelector } from "../../store/hooks";

export function AlbumnComponent(props: Albumn) {
  return (
    <div className="relative group flex flex-row gap-3 p-3 rounded-lg justify-start items-center hover:bg-[#e0dede] transition-colors cursor-pointer">
      <img
